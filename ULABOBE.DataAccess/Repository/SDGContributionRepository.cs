...
{
    public class SDGContributionRepository : Repository<SDGContribution>, ISDGContributionRepository
    {
        private readonly ApplicationDbContext _db;
        public SDGContributionRepository(ApplicationDbContext db) :base(db)
        {
            _db = db;
        }

        public void Update(SDGContribution sDGContribution)
        {
