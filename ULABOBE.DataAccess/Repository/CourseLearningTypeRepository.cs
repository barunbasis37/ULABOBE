...
{
    public class CourseLearningTypeRepository : Repository<CourseLearningType>, ICourseLearningTypeRepository
    {
        private readonly ApplicationDbContext _db;
        public CourseLearningTypeRepository(ApplicationDbContext db) :base(db)
        {
            _db = db;
        }

        public void Update(CourseLearningType courseLearningType)
        {
