...
{
    public class ProgramPLORepository : Repository<ProgramPLO>, IProgramPLORepository
    {
        private readonly ApplicationDbContext _db;
        public ProgramPLORepository(ApplicationDbContext db) :base(db)
        {
            _db = db;
        }

        public void Update(ProgramPLO programPLO)
        {
