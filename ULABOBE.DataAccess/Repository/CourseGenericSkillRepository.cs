...
{
    public class CourseGenericSkillRepository : Repository<CourseGenericSkill>, ICourseGenericSkillRepository
    {
        private readonly ApplicationDbContext _db;
        public CourseGenericSkillRepository(ApplicationDbContext db) :base(db)
        {
            _db = db;
        }

        public void Update(CourseGenericSkill courseGenericSkill)
        {
