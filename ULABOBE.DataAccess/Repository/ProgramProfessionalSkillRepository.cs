...
{
    public class ProgramProfessionalSkillRepository : Repository<ProgramProfessionalSkill>, IProgramProfessionalSkillRepository
    {
        private readonly ApplicationDbContext _db;
        public ProgramProfessionalSkillRepository(ApplicationDbContext db) :base(db)
        {
            _db = db;
        }

        public void Update(ProgramProfessionalSkill programProfessionalSkill)
        {
            ...
            //    _db.SaveChanges();
            //}
            _db.Update(programProfessionalSkill);
        }
    }
}
